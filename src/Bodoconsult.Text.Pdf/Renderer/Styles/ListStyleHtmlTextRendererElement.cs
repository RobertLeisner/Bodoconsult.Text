...
/// </summary>
public class ListStylePdfTextRendererElement : PdfParagraphStyleTextRendererElementBase
{
    ...
    /// Default ctor
    /// </summary>
    public ListStylePdfTextRendererElement(ListStyle listStyle) : base(listStyle)
    {
