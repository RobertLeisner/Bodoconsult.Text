...
/// </summary>
public class BoldHtmlTextRendererElement : InlineHtmlTextRendererElementBase
{
    ...
    public BoldHtmlTextRendererElement(Bold span)
    {
        _span = span;
    }
    ...
    public override void RenderToString(ITextDocumentRenderer renderer, StringBuilder sb)
    {
        ...
        {
            DocumentRendererHelper.RenderInlineChildsToHtml(renderer, sb, _span.ChildInlines, tag: "b");
