...
public class ContentParser
{
    ...
    public void Parse()
    {
        ...
        //// Check start
        //tag = _content.Substring(i + 1, j - i - 1).FirstCharToUpperCase();
        ...
        //while (true)
        //{
        //    tag = _content.Substring(i + 1, j - i - 1).ToLowerInvariant();

        //    if (StartTags.Contains(tag))
        //    {
        //        if (i > 0)
        //        {
        //            var item = _content.Substring(start, i);
        //            ChooseInline(_inlines, "s", item);
        //        }
        //    }

        //    // Find next tag
        //    start = j + 1;
        //    i = _content.IndexOf("<", j + 1, StringComparison.InvariantCultureIgnoreCase);
        //    j = _content.IndexOf(">", i + 1, StringComparison.InvariantCultureIgnoreCase);

        //    if (i < 0 || j < 0)
        //    {
        //        ChooseInline(_inlines, tag, _content.Substring(start, _content.Length - start));
        //        return;
        //    }

        //    var nextTag = _content.Substring(i + 1, j - i - 1).ToLowerInvariant();

        //    if (nextTag == $"/{tag}")
        //    {
        //        ChooseInline(_inlines, tag, _content.Substring(start, i - start));

        //        if (j == _content.Length - 1)
        //        {
        //            return;
        //        }
        ...
        //        if (i < 0 || j < 0)
        //        {
        //            ChooseInline(_inlines, "s", _content.Substring(start, _content.Length - start));
        //            return;
        //        }
        //    }
        //}
